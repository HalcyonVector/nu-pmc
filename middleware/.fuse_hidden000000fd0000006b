...
const validators = {
  ...
  userCreate: makeValidator({
    ...
    role:      { required: true,  enum: ['principal','design_principal','design_head','team_lead','services_head','team_lead','jr_architect','jr_engineer','services_engineer','coordinator','pmc_head','site_manager','senior_site_manager','finance_admin','trainee','audit','it_admin','detailing','detailing_head'] },
