...
//   1. For a project: creates rooms #PV{n}-site, -finance, -design, -general
//   2. Records each as a row in matrix_rooms (project_id, room_type, room_id)
//   3. Bot rooms (-site, -finance, -design) created with encryption OFF
//      (polls don't work in encrypted rooms — brief §6.2, §7.2)
//   4. -general room created with encryption ON (human-only discussion)
//
