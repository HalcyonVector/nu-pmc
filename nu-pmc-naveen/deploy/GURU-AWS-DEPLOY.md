...
# Edit: replace YOUR_DOMAIN with actual domain (e.g. pmc.nuassociates.com)

sudo nginx -t
sudo systemctl enable --now nginx

# Get a Let's Encrypt cert
sudo certbot --nginx -d pmc.nuassociates.com
# Follow prompts. Certbot will update the nginx config automatically.

# Test HTTPS
curl -I https://pmc.nuassociates.com
# Should return HTTP/2 200
```

### Step 5 — First login

Open `https://pmc.nuassociates.com` in a browser.
...
- **Praveen / Murugesan** — PMC on site at PV 90; they are your field testers
