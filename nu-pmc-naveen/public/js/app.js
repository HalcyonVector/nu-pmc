  ...
  showApp() {
    ...
    if (['site_manager','senior_site_manager'].includes(APP.user.role)) {
      ...
      if (projects.length === 0) {
        UI.contentEl().innerHTML = '<div class="empty"><div class="empty-icon">🏗</div><div class="empty-text">No projects assigned yet.<br>Contact Murugesan or Praveen.</div></div>';
  ...
  UI.showModal('Register New Vendor', `
    <div class="field">
      ...
      <div style="display:flex;gap:6px">
        <input id="vm-gstin" placeholder="29AAVFN2055K1ZM" style="flex:1" maxlength="15"
...
// ── GOVERNANCE ADMIN ────────────────────────────────────────────────────────
// Principal-only screen for uploading governance Excel sheets and viewing
