...
router.get('/:project_id/engagements', requireAuth, requireProjectScope(),
  requireRole('principal','design_principal','pmc_head','design_head','services_head','finance_admin','senior_site_manager','site_manager','detailing_head','team_lead','coordinator'),
  asyncHandler(async (req, res) => {
    const me        = req.session.user;
