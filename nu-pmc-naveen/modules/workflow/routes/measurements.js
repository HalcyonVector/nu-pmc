...
router.get('/:project_id/:measurement_id/certificate', requireAuth, asyncHandler(async (req, res) => {
    ...
    doc.fontSize(8).font('Helvetica').fillColor('grey')
       .text('NU ASSOCIATES LLP — 1st Floor, No.940, Shantha Complex, 20th Main Road, Banashankari Stage 2, Bengaluru 560070',
             { align: 'center' })
       .text('GSTIN: 29AAVFN2055K1ZM  ·  Naveen@nuassociates.com', { align: 'center' });
