...
('naveen',    '$2b$10$placeholder', 'Naveen Kumar Bhat',   'principal',         'all',      NULL),
('ajay',      '$2b$10$placeholder', 'Ajay Appachu',        'design_principal',  'all',      NULL),
-- PMC Heads (managed by naveen=1)
('murugesan', '$2b$10$placeholder', 'Murugesan K',         'pmc_head',          'pmc',      1),
('praveen',   '$2b$10$placeholder', 'Praveen Kumar',       'pmc_head',          'pmc',      1),
-- Design Head (managed by ajay=2)
('rajani',    '$2b$10$placeholder', 'Rajani Gowda K',      'design_head',       'design',   2),
...
INSERT INTO company_entities
  (entity_code, legal_name, address_line1, gstin, state_code,
   email_primary, email_finance, phone,
   bank_name, bank_account_no, bank_ifsc, bank_account_holder, bank_branch, upi_id)
VALUES
  ('PROP',
   'NU ASSOCIATES',
   'No.940, Shantha Complex, 1st Floor, 20th Main Road, Banashankari Stage 2, Bengaluru 560070',
   '29AHSPB4003H1ZH', '29',
   'naveen@nuassociates.com', 'finance@nuassociates.com', '9886050673',
   'ICICI Bank', '233705001068', 'ICIC0002337', 'NU ASSOCIATES', 'Banashankari, Bengaluru', NULL),
  ('LLP',
   'NU ASSOCIATES LLP',
   '1st Floor, No.940, Shantha Complex, 20th Main Road, Banashankari Stage 2, Bengaluru 560070',
   '29AAVFN2055K1ZM', '29',
   'naveen@nuassociates.com', 'finance@nuassociates.com', '9886050673',
   'ICICI Bank', '233705000984', 'ICIC0002337', 'NU ASSOCIATES LLP', 'Banashankari, Bengaluru',
   'nuassociatesllp.ibz@icici');
