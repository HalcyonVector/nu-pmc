...
> ⚠️ **This is the V5 hardening audit (26 Apr 2026), covering compartments 1–6.**
> The current build is v5.41 (2 May 2026). For the current test baseline see
> `CLAUDE_WORKING_STRATEGY.md` (1365 passing, 0 failures across both suites).
> Migrations v5.38–v5.41 (Matrix substrate, external_comm_assignments) are
> not covered by this document. Items
