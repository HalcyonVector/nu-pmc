...
<div class="sig">
  ...
  <div class="sig-block">
    <p>For ${pi.firm_name}</p>
    <div class="name" style="min-height:32px"></div>
    <div class="role">Authorised Signatory</div>
    <p style="margin-top:20px; border-top:1px solid #CCC; padding-top:4px; font-size:9px; color:#CCC;">Sign above</p>
  </div>
</div>
