...
INSERT INTO `ai_feature_toggles` VALUES ('autofill_boq_hsn',0,'Auto-fill BOQ HSN','Wires suggestHSN button in BOQ edit modal',1,'2026-06-10 22:35:49'),('detail_drawing_analysis',0,'Auto Detail Drawing Analysis','Extracts trade/reference info from detail uploads',NULL,'2026-06-10 22:03:42'),('drawing_sanity_check',0,'Auto Drawing Sanity Check','Drawing upload metadata validation',NULL,'2026-06-10 22:03:42'),('hsn_code_suggestion',0,'HSN Code Suggestion','Auto-suggests HSN code on BOQ item edit',NULL,'2026-06-10 22:03:42'),('material_approval_check',0,'Material Approval Check','Flags BOQ items needing client material approval',NULL,'2026-06-10 22:03:42'),('photo_auto_tagging',0,'Photo Auto-Tagging','Suggests task association for uploaded site photos',1,'2026-06-10 22:15:09'),('revision_change_analysis',0,'Auto Revision Change Analysis','Compares old vs new drawing, flags impacts',NULL,'2026-06-10 22:03:42'),('rfi_response_check',0,'Auto RFI Response Check','Checks if uploaded drawing answers the RFI',NULL,'2026-06-10 22:03:42'),('similar_query_dedup',0,'Similar Query Dedup','Wires checkSimilarQueries button in Raise Query modal',39,'2026-06-12 16:15:48'),('similar_query_search',0,'Similar Query Search','Shows past matching queries while raising a new one',NULL,'2026-06-10 22:03:42');
...
INSERT INTO `company_entities` VALUES (1,'PROP','NU ASSOCIATES','No.940, Shantha Complex, 1st Floor, 20th Main Road, Banashankari Stage 2, Bengaluru 560070',NULL,'Bengaluru','Karnataka','560070','29AHSPB4003H1ZH','29','principal@nuassociates.com','finance@nuassociates.com','9886050673','998311','ICICI Bank','233705001068','ICIC0002337','NU ASSOCIATES','Banashankari, Bengaluru',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:16'),(2,'LLP','NU ASSOCIATES LLP','1st Floor, No.940, Shantha Complex, 20th Main Road, Banashankari Stage 2, Bengaluru 560070',NULL,'Bengaluru','Karnataka','560070','29AAVFN2055K1ZM','29','principal@nuassociates.com','finance@nuassociates.com','9886050673','998311','ICICI Bank','233705000984','ICIC0002337','NU ASSOCIATES LLP','Banashankari, Bengaluru','nuassociatesllp.ibz@icici',NULL,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:16');
...
CREATE TABLE `lessons_learned` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int unsigned NOT NULL,
  `ai_draft` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `ai_drafted_at` datetime DEFAULT NULL,
  `published_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
INSERT INTO `lessons_learned` VALUES (1,1,'LESSONS LEARNED ΓÇö DRAFT (AI returned no content)\n\nWhat went well:\n- [principal] Principal Kumar Bhat: Civil work coordination was excellent. Vendor delivery was on time for structural steel.','2026-06-10 20:56:18','This is the published lessons learned document for PV90.','2026-06-10 20:57:52',1,'2026-06-10 20:17:07','2026-06-10 20:57:52');
...
CREATE TABLE `lessons_learned_inputs` (
  ...
  `category` enum('what_went_well','improvement','recommendation','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'other',
...
INSERT INTO `lessons_learned_inputs` VALUES (1,1,1,'Civil work coordination was excellent. Vendor delivery was on time for structural steel.','what_went_well',0,'2026-06-10 20:56:18','2026-06-10 20:56:18');
...
CREATE TABLE `matrix_rooms` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `project_id` int unsigned DEFAULT NULL,
  `room_type` enum('coordination','internal','finance','internal_principal','internal_finance','system_health','site','design','general') COLLATE utf8mb4_general_ci NOT NULL,
  `room_id` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `notifications_config` VALUES (1,'morning_pmc','07:00:00',1,'2026-06-02 12:12:00','2026-06-02 12:12:00'),(2,'principal_morning','08:00:00',1,'2026-06-02 12:12:00','2026-06-02 12:12:00'),(3,'closeout','21:00:00',1,'2026-06-02 12:12:00','2026-06-02 12:12:00');
...
CREATE TABLE `project_assignments` (
  ...
  `project_id` int unsigned NOT NULL,
  `user_id` int unsigned NOT NULL,
  `role` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `project_assignments` VALUES (1,1,2,'member',1,'2026-04-22 17:25:19',1),(4,1,1,'member',1,'2026-04-22 17:25:19',1),(7,1,21,'member',1,'2026-04-22 17:25:19',1),(8,1,31,'member',1,'2026-04-22 17:25:19',1),(9,1,24,'member',1,'2026-04-22 17:25:19',1),(11,1,29,'member',1,'2026-04-22 17:25:19',1),(13,1,35,'member',1,'2026-04-22 17:25:19',1),(14,1,38,'member',1,'2026-04-22 17:25:19',1),(15,1,28,'member',1,'2026-04-22 17:25:19',1),(16,1,32,'member',1,'2026-04-22 17:25:19',1),(18,1,30,'member',1,'2026-04-22 17:25:19',1),(19,1,26,'member',1,'2026-04-22 17:25:19',1),(20,1,33,'member',1,'2026-04-22 17:25:19',1),(21,1,34,'member',1,'2026-04-22 17:25:19',1),(22,1,25,'member',1,'2026-04-22 17:25:19',1),(23,1,36,'member',1,'2026-04-22 17:25:19',1),(32,2,32,'pmc_head',1,'2026-06-03 13:33:51',1),(33,2,33,'site_manager',1,'2026-06-03 13:33:51',1),(35,4,25,'member',1,'2026-06-05 11:26:44',1),(37,4,28,'member',1,'2026-06-05 11:26:44',1),(46,1,39,'member',1,'2026-06-05 11:35:17',1);
...
CREATE TABLE `role_permissions` (
  ...
  KEY `idx_role` (`role`)
) ENGINE=InnoDB AUTO_INCREMENT=2491 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schedule_tasks` VALUES (1,1,1,'Civil','Site mobilisation','2026-03-23','2026-03-25',NULL,1,0,'schedule','Mobilisation complete',1,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(2,1,1,'Civil','Foundation excavation','2026-03-26','2026-04-02',NULL,0,0,'none',NULL,2,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(3,1,1,'Civil','Foundation concrete','2026-04-03','2026-04-10',NULL,1,0,'both','Foundation cast',3,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(4,1,1,'Civil','Floor slab + columns','2026-04-11','2026-04-24',NULL,0,0,'none',NULL,4,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(5,1,1,'Electrical','Conduit rough-in','2026-04-15','2026-04-25',NULL,0,0,'none',NULL,5,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(6,1,1,'Electrical','Cable pulling','2026-04-26','2026-05-05',NULL,0,0,'none',NULL,6,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(7,1,1,'Electrical','Panel termination','2026-05-06','2026-05-12',NULL,1,0,'payment','Power-on milestone',7,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(8,1,1,'HVAC','Ductwork install','2026-04-28','2026-05-08',NULL,0,0,'none',NULL,8,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(9,1,1,'HVAC','AHU commissioning','2026-05-10','2026-05-18',NULL,1,0,'payment','HVAC live',9,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(10,1,1,'Civil','Snagging + handover','2026-05-19','2026-05-25',NULL,1,0,'both','Practical completion',10,0,'not_started','2026-06-13 12:14:42','2026-04-22 17:25:19',NULL,NULL,'medium'),(11,1,1,'Civil','Ad-hoc Planning Task','2026-06-03','2026-06-03',NULL,0,0,'none',NULL,11,0,'not_started','2026-06-13 12:14:42','2026-06-03 13:42:02','Scheduled from Look Ahead workspace test',NULL,'high'),(12,1,1,'Civil','Ad-hoc Planning Task','2026-06-03','2026-06-03',NULL,0,0,'none',NULL,12,0,'not_started','2026-06-13 12:14:42','2026-06-03 13:45:25','Scheduled from Look Ahead workspace test',NULL,'high');
...
CREATE TABLE `task_updates` (
  ...
  `flag_resolution_note` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_by` int unsigned NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `daily_report_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `task_updates` VALUES (1,12,1,'2026-06-03',0,NULL,0,NULL,0,NULL,NULL,NULL,39,'2026-06-03 13:49:38',NULL),(4,11,1,'2026-06-03',70,NULL,0,NULL,0,NULL,NULL,NULL,39,'2026-06-03 18:43:33',NULL),(9,2,1,'2026-06-04',0,NULL,1,'Auto-flagged: 100.0% behind plan',0,NULL,NULL,NULL,32,'2026-06-04 13:34:14',NULL),(10,4,1,'2026-06-04',0,NULL,1,'Auto-flagged: 100.0% behind plan',0,NULL,NULL,NULL,32,'2026-06-04 13:34:14',NULL),(11,5,1,'2026-06-04',0,NULL,1,'Auto-flagged: 100.0% behind plan',0,NULL,NULL,NULL,32,'2026-06-04 13:34:14',NULL),(12,6,1,'2026-06-04',0,NULL,1,'Auto-flagged: 100.0% behind plan',0,NULL,NULL,NULL,32,'2026-06-04 13:34:14',NULL),(13,8,1,'2026-06-04',0,NULL,1,'Auto-flagged: 100.0% behind plan',0,NULL,NULL,NULL,32,'2026-06-04 13:34:14',NULL);
...
CREATE TABLE `users` (
  ...
  `full_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `role` enum('principal','design_principal','design_head','services_head','pmc_head','detailing_head','team_lead','jr_architect','detailing','jr_engineer','services_engineer','coordinator','site_manager','senior_site_manager','finance_admin','trainee','audit','it_admin') COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'principal','$2a$10$/wyKZq4wmJmDwkOe4lKcBerMI69nX7BIw6Y1vgf/UUYlPqnZgTd2.','Principal','principal','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:13','2026-06-12 22:38:29'),(2,'design_principal','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Design Principal','design_principal','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:13','2026-06-12 22:38:29'),(21,'audit','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Audit Account','audit','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:18','2026-06-09 17:59:56'),(24,'design_head','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Design Head','design_head','design',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(25,'team_lead','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Team Lead','team_lead','design',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(26,'services_head','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Services Head','services_head','services',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(28,'jr_architect','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Junior Architect','jr_architect','design',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(29,'jr_engineer','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Jr Engineer','jr_engineer','design',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-12 22:40:30'),(30,'services_eng','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Services Eng','services_engineer','services',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(31,'coordinator','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Coordinator','coordinator','pmc',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(32,'pmc_head','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','PMC Head','pmc_head','pmc',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(33,'site_manager','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Site Manager','site_manager','site',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(34,'sr_site_manager','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Sr Site Manager','senior_site_manager','site',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(35,'finance_admin','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Finance Admin','finance_admin','pmc',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(36,'trainee','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Trainee','trainee','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(38,'it_admin','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','IT Admin','it_admin','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-04-22 17:25:19','2026-06-09 17:59:56'),(39,'user1','$2a$10$AqLulRskI/9iWRo4RqS97ua/NWoCUo/vI.tivp3xuJGbmI106QcC6','Dev Tester','principal','all',NULL,NULL,NULL,NULL,1,1,0,NULL,NULL,NULL,NULL,NULL,1,'2026-06-02 17:42:24','2026-06-09 17:59:56');
...
INSERT INTO `weekly_reports` VALUES (1,1,'2026-06-07',23,'Test summary','None','draft',1,NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'C:\\Users\\basus\\Documents\\Internship\\NUAssociates\\nu-pmc-main\\uploads\\documents\\weekly_report_1_wk23_1781117111818.pdf','2026-06-10 19:58:55','2026-06-11 00:15:11'),(2,1,'2026-06-14',24,'Testing','None','draft',1,NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'C:\\Users\\basus\\Documents\\Internship\\NUAssociates\\nu-pmc-main\\uploads\\documents\\weekly_report_1_wk24_1781118091665.pdf','2026-06-10 19:59:11','2026-06-11 00:31:31');
...
-- Dump completed on 2026-06-14  8:35:05
