...
(1,1,'ISS-001','rfi','Clarify foundation depth at Grid A1','Drawing shows 1200mm but site soil report suggests 1500mm. Please confirm.',1,'2026-04-22 17:25:19',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,'open',NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,0,NULL,NULL,NULL,NULL,'text',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),
(2,1,'ISS-002','design','Column C3 spec mismatch','BOQ says M30 but drawing notes M25. Confirm which is correct.',1,'2026-04-22 17:25:19',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,'open',NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,0,NULL,NULL,NULL,NULL,'text',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),
(3,1,'ISS-003','safety','Scaffolding stability â€” east facade','Wind load conditions require additional bracing. Inspect.',1,'2026-04-22 17:25:19',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'open',NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,0,NULL,NULL,NULL,NULL,'text',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),
(4,1,'ISS-004','quality','Concrete honeycombing at column C3','Surface finish not as per spec. Re-pour or patch?',1,'2026-04-22 17:25:19',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'open',NULL,NULL,0,NULL,NULL,NULL,NULL,0,0,NULL,0,NULL,NULL,NULL,NULL,'text',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL);
...
(114,'detailing_head','home','dashboard',1,1,'2026-04-22 17:25:18'),
(115,'detailing_head','home','project_detail',2,1,'2026-04-22 17:25:18'),
(116,'detailing_head','work','drawings',1,1,'2026-04-22 17:25:18'),
(117,'detailing_head','work','issues',2,1,'2026-04-22 17:25:18'),
(118,'detailing_head','work','register',3,1,'2026-04-22 17:25:18'),
(119,'detailing_head','work','submittals',4,1,'2026-04-22 17:25:18'),
...
CREATE TABLE `schedule_tasks` (
  ...
  `display_order` int(10) unsigned NOT NULL DEFAULT 0,
  `float_days` int(11) NOT NULL DEFAULT 0,
...
(1,1,1,'Civil','Site mobilisation','2026-03-23','2026-03-25',NULL,1,0,'schedule','Mobilisation complete',1,0,'not_started',NULL,'2026-04-22 17:25:19'),
(2,1,1,'Civil','Foundation excavation','2026-03-26','2026-04-02',NULL,0,0,'none',NULL,2,0,'not_started',NULL,'2026-04-22 17:25:19'),
(3,1,1,'Civil','Foundation concrete','2026-04-03','2026-04-10',NULL,1,0,'both','Foundation cast',3,0,'not_started',NULL,'2026-04-22 17:25:19'),
(4,1,1,'Civil','Floor slab + columns','2026-04-11','2026-04-24',NULL,0,0,'none',NULL,4,0,'not_started',NULL,'2026-04-22 17:25:19'),
(5,1,1,'Electrical','Conduit rough-in','2026-04-15','2026-04-25',NULL,0,0,'none',NULL,5,0,'not_started',NULL,'2026-04-22 17:25:19'),
(6,1,1,'Electrical','Cable pulling','2026-04-26','2026-05-05',NULL,0,0,'none',NULL,6,0,'not_started',NULL,'2026-04-22 17:25:19'),
(7,1,1,'Electrical','Panel termination','2026-05-06','2026-05-12',NULL,1,0,'payment','Power-on milestone',7,0,'not_started',NULL,'2026-04-22 17:25:19'),
(8,1,1,'HVAC','Ductwork install','2026-04-28','2026-05-08',NULL,0,0,'none',NULL,8,0,'not_started',NULL,'2026-04-22 17:25:19'),
(9,1,1,'HVAC','AHU commissioning','2026-05-10','2026-05-18',NULL,1,0,'payment','HVAC live',9,0,'not_started',NULL,'2026-04-22 17:25:19'),
(10,1,1,'Civil','Snagging + handover','2026-05-19','2026-05-25',NULL,1,0,'both','Practical completion',10,0,'not_started',NULL,'2026-04-22 17:25:19');
...
CREATE TABLE `approval_type_config` (
  ...
  `signer_roles_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`signer_roles_json`)),
  `quorum` tinyint(3) unsigned NOT NULL DEFAULT 1,
  `scope` enum('project','global') NOT NULL DEFAULT 'project',
  `requires_vendor_confirm` tinyint(1) NOT NULL DEFAULT 0,
  `expires_after_hours` int(10) unsigned DEFAULT NULL,
  `label` varchar(120) NOT NULL,
  `description` text DEFAULT NULL,
  `sheet_source` varchar(40) DEFAULT NULL,
...
INSERT INTO `approval_type_config` (`approval_type`,`signer_roles_json`,`quorum`,`scope`,`requires_vendor_confirm`,`expires_after_hours`,`label`,`description`,`sheet_source`,`active`) VALUES
('cn_approval','["principal","design_principal"]',1,'project',0,72,'Change Notice approval','PLACEHOLDER: high-value path only.','sheet9_seed_v5.24',1),
('schedule_change','["principal","design_principal"]',1,'project',0,72,'Schedule baseline change','PLACEHOLDER: matches current requirePrincipal gate.','sheet9_seed_v5.24',1),
('weekly_report','["principal","design_principal"]',1,'project',0,168,'Weekly report sign-off','PLACEHOLDER: principals only.','sheet9_seed_v5.24',1),
('vendor_payment','["principal","design_principal","pmc_head"]',1,'project',0,168,'Vendor payment approval','PLACEHOLDER: matches current requirePMC gate.','sheet9_seed_v5.24',1),
('vendor_bank_change','["principal","design_principal"]',1,'global',1,72,'Vendor bank change','PLACEHOLDER: principals only.','sheet9_seed_v5.24',1),
('claim_invoice','["principal","design_principal"]',1,'project',0,168,'Client claim approval','PLACEHOLDER: final-approve step only.','sheet9_seed_v5.24',1),
('budget_cost_head','["principal","design_principal"]',1,'project',0,72,'Budget cost head approval','PLACEHOLDER: principals only.','sheet9_seed_v5.24',1),
('handover_closure','["principal","design_principal","pmc_head","finance_admin"]',4,'project',0,NULL,'Project handover closure','PLACEHOLDER: 4-signer quorum design.','sheet9_seed_v5.24',1),
('vendor_onboarding','["finance_admin","principal"]',2,'global',0,2880,'Vendor onboarding','Vendor onboarding approval — finance then principal.','sheet9_seed_v6.02',1);
...
(NULL,'min_headcount',8),
(NULL,'float_days',3),
(NULL,'overdue_days',2),
(NULL,'grn_pending_days',3),
(NULL,'snag_pending_days',7),
(NULL,'budget_alert_pct',90);
...
-- ── notifications_config — digest schedule (C11 / P7.4) ─────────────────
-- Drives daily digest send times. One row per digest type.
-- digest-runner.js reads (digest_type, send_time, active) at cron fire time.
...
-- Prevents the same threshold alert firing more than once per band.
-- category_name stores cb.trade from client_boq_items (the grouping key).
...
-- ── client_errors — frontend error reporter ──────────────────────────────
-- public/js/api.js posts here on any non-2xx response so principals can
-- triage broken endpoints. Schema mirrors what modules/system/routes/
-- client-errors.js inserts and reads (id, request meta, triage state).
CREATE TABLE IF NOT EXISTS `client_errors` (
  `id`               INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `user_id`          INT UNSIGNED NULL,
  `user_role`        VARCHAR(40)  NULL,
  `user_full_name`   VARCHAR(120) NULL,
  ...
  `client_path`      VARCHAR(200) NULL,
  `triaged_at`       DATETIME     NULL,
  `triaged_by`       INT UNSIGNED NULL,
  `triage_note`      VARCHAR(500) NULL,
  `created_at`       DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
  INDEX `idx_client_errors_created` (`created_at`),
  INDEX `idx_client_errors_untriaged` (`triaged_at`, `created_at`),
  INDEX `idx_client_errors_path` (`request_method`, `request_path`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ── Migration tables (ported from nu-pmc-install-20260502.sql) ────────

-- ── vendor_bank_change_approvals ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS `vendor_bank_change_approvals` (
  ...
  `before_bank_name` varchar(200) DEFAULT NULL,
  `before_bank_account` varchar(50) DEFAULT NULL,
  `before_bank_ifsc` varchar(20) DEFAULT NULL,
  `after_bank_name` varchar(200) DEFAULT NULL,
  `after_bank_account` varchar(50) DEFAULT NULL,
  `after_bank_ifsc` varchar(20) DEFAULT NULL,
  `approved_by` int unsigned DEFAULT NULL,
  `approved_by_role` varchar(40) DEFAULT NULL,
  `approved_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vendor_alerts` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `matrix_event_id` varchar(255) DEFAULT NULL,
  `matrix_room_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `matrix_outbox` (
  ...
  `body` text NOT NULL,
  `mxc_url` varchar(500) DEFAULT NULL,
  `recipient_uid` int unsigned DEFAULT NULL,
  `status` enum('pending','sending','sent','failed','dry_run') NOT NULL DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `signoff_workflows` (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `destination_kind` varchar(10) NOT NULL DEFAULT 'project' COMMENT 'personal | project | org — where the bot posts',
  `destination_qualifier` varchar(50) DEFAULT NULL COMMENT 'personal:role-token | project:internal/finance | org:room-name',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `signoff_instances` (
  ...
  `document_id` int unsigned NOT NULL,
  `project_id` int unsigned DEFAULT NULL,
  `poll_event_id` varchar(255) DEFAULT NULL,
  `poll_room_id` varchar(255) DEFAULT NULL,
  ...
  `result` enum('approved','rejected','no_quorum','timed_out') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `signoff_votes` (
  ...
  `voter_mxid` varchar(255) DEFAULT NULL,
  `vote_answer_id` varchar(64) NOT NULL,
  `vote_event_id` varchar(255) DEFAULT NULL,
  `voted_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `document_attachments` (
  ...
  `uploaded_by_mxid` varchar(255) DEFAULT NULL,
...
-- ── Migration seed data (workflows, rules, configs) ───────────────────

-- signoff_workflows — 30 rows
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (1,'daily_report','poll',1,120,NULL,'pmc',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (2,'grn_approval','poll',1,120,NULL,'pmc',NULL,0,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
...
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (12,'handover_checklist','poll',2,NULL,NULL,'pmc,client_rep',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (13,'cn_design_ratification','poll',1,2880,NULL,'design_lead',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','personal',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (14,'issue_confirm','poll',1,1440,NULL,'pmc',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (15,'urgent_payment_fyi','poll',1,240,NULL,'pmc',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (16,'drawing_approval','poll',1,1440,NULL,'design_lead,services_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project','internal');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (17,'vendor_bank_peer_approve','poll',1,NULL,NULL,'finance,principal',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','org','internal_finance');
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (18,'vendor_bank_vendor_confirm','poll',1,4320,NULL,'vendor_rep',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','personal',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (19,'ncr_endorsement','poll',1,2880,NULL,'principal',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (20,'payment_request_finance_review','poll',1,480,NULL,'finance_admin',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (21,'petty_cash_replenishment','poll',1,480,NULL,'finance_admin',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (22,'submittal_pmc_review','poll',1,1440,NULL,'pmc',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (23,'submittal_design_review','poll',1,1440,NULL,'design_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (24,'submittal_services_review','poll',1,1440,NULL,'services_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (25,'drawing_approval_design','poll',1,1440,NULL,'design_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (26,'drawing_approval_services','poll',1,1440,NULL,'services_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (27,'measurement_approval','poll',1,1440,NULL,'services_head',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','project',NULL);
INSERT IGNORE INTO `signoff_workflows` (`id`, `workflow_type`, `signoff_type`, `quorum_required`, `closing_minutes`, `principal_threshold_pct`, `sequence`, `escalation_user_id`, `active`, `created_at`, `updated_at`, `destination_kind`, `destination_qualifier`) VALUES (28,'grn_vendor_confirm','poll',1,1440,NULL,'vendor_rep',NULL,1,'2026-05-09 07:01:31','2026-05-09 07:01:31','personal',NULL);
...
-- signoff_sequence_rules — 9 rows
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (1,'change_notice',10,'always','strip_initiator',NULL,'CN initiator does not approve own document',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (2,'change_notice',20,'is_emergency','skip_role','design_lead','Emergency CN — Design ratifies after, not before',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (3,'change_notice',30,'below_threshold','skip_role','principal','Below 1% threshold — PMC + Design only',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (4,'change_notice',90,'external_origin','append_role','client_rep','External CN closes with client confirmation',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (5,'project_closure',20,'no_snags','skip_role','design_lead','No snags ever raised — Design Lead has nothing to confirm cleared',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (6,'project_closure',30,'settlement_pending','skip_role','finance','Final settlement not complete — Finance step deferred and resumed',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (7,'drawing_approval',20,'is_services_stream','skip_role','design_lead','services drawing — design lead does not approve',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (8,'drawing_approval',20,'is_design_stream','skip_role','services_head','design drawing — services head does not approve',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');
INSERT IGNORE INTO `signoff_sequence_rules` (`id`, `workflow_type`, `priority`, `predicate_name`, `action_name`, `role_token`, `notes`, `active`, `created_at`, `updated_at`) VALUES (9,'vendor_bank_peer_approve',10,'always','strip_initiator',NULL,'V8 separation of duties — proposer cannot approve their own bank-change proposal',1,'2026-05-09 07:01:31','2026-05-09 07:01:31');

-- external_comm_config — 5 rows
INSERT IGNORE INTO `external_comm_config` (`id`, `activity_type`, `workflow_type`, `responsible_role`, `due_hours`, `label`, `active`, `created_at`) VALUES (1,'vendor_bank_confirm','vendor_bank_vendor_confirm','finance_admin',4,'Send bank confirmation request to vendor',1,'2026-05-09 07:01:31');
INSERT IGNORE INTO `external_comm_config` (`id`, `activity_type`, `workflow_type`, `responsible_role`, `due_hours`, `label`, `active`, `created_at`) VALUES (2,'vendor_bank_new','vendor_bank_vendor_confirm','finance_admin',4,'Send new bank details confirmation to vendor',1,'2026-05-09 07:01:31');
INSERT IGNORE INTO `external_comm_config` (`id`, `activity_type`, `workflow_type`, `responsible_role`, `due_hours`, `label`, `active`, `created_at`) VALUES (3,'payment_utr_confirm',NULL,'finance_admin',2,'Send payment UTR confirmation to vendor',1,'2026-05-09 07:01:31');
INSERT IGNORE INTO `external_comm_config` (`id`, `activity_type`, `workflow_type`, `responsible_role`, `due_hours`, `label`, `active`, `created_at`) VALUES (4,'vendor_defect_raised',NULL,'pmc_head',8,'Notify vendor: defect raised',1,'2026-05-09 07:01:31');
INSERT IGNORE INTO `external_comm_config` (`id`, `activity_type`, `workflow_type`, `responsible_role`, `due_hours`, `label`, `active`, `created_at`) VALUES (5,'grn_pending',NULL,'pmc_head',8,'Notify vendor: GRN pending approval',1,'2026-05-09 07:01:31');

-- security_config — 5 rows
